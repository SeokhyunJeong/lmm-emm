...
"Large multimodal model-based environment-aware mobility management", IEEE Transactions on Wireless Communications,  
...
### **BibTeX** (IEEE Style)
```bibtex
@article{jeong2026large,
  title={Large multimodal model-based environment-aware mobility management},
  author={Jeong, Seokhyun and Shin, Sangmok and Kim, Seungnyun and Wu, Jiao and Shim, Byonghyo},
